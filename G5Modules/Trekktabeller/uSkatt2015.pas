...
const
  KLASSE1_VANLIG               = 50400;
  KLASSE2_VANLIG               = 74250;
  KLASSE1_FINNMARK             = 65900;
  KLASSE2_FINNMARK             = 89750;
...
const
  ...
  TOPPSKATT_LAV                : Tabell3 = ( 0, 550550, 550550 );
  TOPPSKATT_HOY                : Tabell3 = ( 0, 885600, 885600 );
  Skattore                     : Extended = 13.85;


var
  FELLES_SKATT_PROSENT:Currency = 0.00;
const
  FELLES_SKATT_VANLIG          = 13.15;
  FELLES_SKATT_FINNMARK        = 9.65;


  LAV_GRENSE_TRYGDEAVGIFT      = 62374;
  HOY_GRENSE_TRYGDEAVGIFT      = 73884;
  AVG_FRI_TRYGDEAVGIFT         = 49650;
  ...
  MAX_ANV_MINSTE_FRADRAG       = 78364;
  MAX_ANV_MINSTE_FRADRAG_PENSJ = 63536;

  MINSTE_FRAD_PROSENT          = 43.0;

  MIN_MINSTE_FRADRAG           = 4000;
  MAX_MINSTE_FRADRAG           = 89050;
...
Function TSkatt2015.GetSumSkatt : LongInt;
Var
  OrgTrgrl : Extended;
  OrgPer   : SmallInt;
begin
...
Function TSkatt2015.GetSumSkattNetto : LongInt;
Var
  OrgTrgrl : Extended;
  OrgPer   : SmallInt;
  Tillegg  : Extended;
...
Procedure TSkatt2015.CalcSkatt;
begin
...
Procedure TSkatt2015.CalcOppgrossing;           { ref id 986 }
begin
...
Procedure TSkatt2015.SettVanlig;
begin
...
Procedure TSkatt2015.SettVanligNetto;
begin
...
Procedure TSkatt2015.SettPensjonist;
begin
...
Procedure TSkatt2015.SettStfradrag;
begin
...
Procedure TSkatt2015.SettSjomann;
begin
...
Procedure TSkatt2015.BeregnAarsGrunnlag;
begin
...
Procedure TSkatt2015.BeregnOverskTrekk;
var
...
Procedure TSkatt2015.BeregnFradrag;
var
...
Procedure TSkatt2015.BeregnNettoskatt;
begin
...
Procedure TSkatt2015.BeregnTrygdeavgift;
begin
...
Procedure TSkatt2015.BeregnToppskatt;
var
  Topp_Skatt_Trinn1     : Extended;
  Topp_Skatt_Trinn2     : Extended;
begin
...
Procedure TSkatt2015.BeregnTrekk;
var
  Trekk     : LongInt;
begin
...
Procedure TSkatt2015.BeregnAarsTrekk;
begin
