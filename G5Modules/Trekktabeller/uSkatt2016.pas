...
const
  KLASSE1_VANLIG               = 51750;
  KLASSE2_VANLIG               = 76250;
  KLASSE1_FINNMARK             = 67250;
  KLASSE2_FINNMARK             = 91750;

const
  TRINNSKATT_GRENSE1 = 159800;
  TRINNSKATT_GRENSE2 = 224900;
  TRINNSKATT_GRENSE3 = 565400;
  TRINNSKATT_GRENSE4 = 909500;

  TRINNSKATT_PROSENT1 = 0.44;
  TRINNSKATT_PROSENT2 = 1.70;
  TRINNSKATT_PROSENT3_VANLIG = 10.7;
  TRINNSKATT_PROSENT3_FINNMARK = 8.7;
  TRINNSKATT_PROSENT4 = 13.7;
...
const
  FELLES_SKATT_VANLIG          = 10.55;
  FELLES_SKATT_FINNMARK        = 7.05;
  ...
  MAX_ANV_MINSTE_FRADRAG       = 80476;
  MAX_ANV_MINSTE_FRADRAG_PENSJ = 64768;

  MINSTE_FRAD_PROSENT          = 43.0;

  MIN_MINSTE_FRADRAG           = 4000;
  MAX_MINSTE_FRADRAG           = 91450;
...
Function TSkatt2016.GetSumSkatt : LongInt;
Var
  OrgTrgrl : Extended;
  OrgPer   : SmallInt;
begin
...
Function TSkatt2016.GetSumSkattNetto : LongInt;
Var
  OrgTrgrl : Extended;
  OrgPer   : SmallInt;
  Tillegg  : Extended;
...
Procedure TSkatt2016.CalcSkatt;
begin
...
Procedure TSkatt2016.CalcOppgrossing;           { ref id 986 }
begin
...
Procedure TSkatt2016.SettVanlig;
begin
...
Procedure TSkatt2016.SettVanligNetto;
begin
...
Procedure TSkatt2016.SettPensjonist;
begin
...
Procedure TSkatt2016.SettStfradrag;
begin
...
Procedure TSkatt2016.SettSjomann;
begin
...
Procedure TSkatt2016.BeregnAarsGrunnlag;
begin
...
Procedure TSkatt2016.BeregnOverskTrekk;
var
...
Procedure TSkatt2016.BeregnFradrag;
var
...
Procedure TSkatt2016.BeregnNettoskatt;
begin
...
Procedure TSkatt2016.BeregnTrygdeavgift;
begin
...
Procedure TSkatt2016.BeregnTrinnskatt;
var
...
Procedure TSkatt2016.BeregnTrekk;
var
  Trekk     : LongInt;
begin
...
Procedure TSkatt2016.BeregnAarsTrekk;
begin
